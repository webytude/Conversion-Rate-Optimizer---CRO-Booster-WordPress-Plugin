 ...
 * @subpackage Cro_Booster/tools
 */
class Cro_Booster_Header_Promotional_Bar_With_Button_TEST {
...
new Cro_Booster_Header_Promotional_Bar_With_Button_TEST( Cro_Booster::get_plugin_name(), Cro_Booster::get_version() );